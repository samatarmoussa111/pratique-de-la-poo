...
{
    protected $modelName = \Models\Comment::class; //$modelName="\Models\Comment"
    ...
    public function insert()
    {
        ...
        Ca nécessite une connexion à la base de données puis une requête
        qui va aller chercher l'article en question
        ...
        */  
        ...
        $this->model->insert(compact('author', 'content', 'article_id'));
